	...
	<div class="main-content">
		<div class="online-strip">
			...
			<div class="col-md-4 online-order">
				<p>Order online</p>
				<h3>Tel:<?php echo get_option('phone', 'Не указан') ?></h3>
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="products-grid">
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p1.jpg"
						alt="" /></a>
				<div class="mask">
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p2.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p3.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p4.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p5.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p6.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p7.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p8.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
			...
			<div class="col-md-4 product simpleCart_shelfItem text-center">
				<a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/p9.jpg"
						alt="" /></a>
				<div class="mask">
					<a href="single.html">Quick View</a>
				</div>
	...
	<div class="container">
		...
		<ul id="flexiselDemo3">
			<li><a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/l1.jpg"
			...
			<li><a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/l2.jpg"
						class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_shelfItem">
			...
			<li><a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/l3.jpg"
						class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_shelfItem">
			...
			<li><a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/l4.jpg"
						class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_shelfItem">
			...
			<li><a href="single.html"><img
						src="<?php echo get_template_directory_uri() . '/assets/' ?>images/l5.jpg"
						class="img-responsive" alt="" /></a>
				<div class="product liked-product simpleCart_shelfItem">
					<a class="like_name" href="single.html">perfectly simple</a>
